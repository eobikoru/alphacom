    ...
    <>
      {/* <PageSEO
        ...
        keywords={[
          ...
          "alphacom store location",
          "tech support lagos",
        ]}
        canonical="https://www.alphacomonline.com/stores"
        openGraph={{
          title: "Visit Our Store - AlphaCom Online Lagos",
        ...
        <div className="min-h-screen bg-background">
          <div className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-20 overflow-hidden">
            <div className="absolute inset-0">
              <img
                src="/modern-computer-store-interior-hero-background.jpg"
            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8" itemProp="description">
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-foreground">Our Store Location</h2>
