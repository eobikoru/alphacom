  ...
  return (
    <>
      {/* <PageSEO
        ...
        keywords={[
          "contact alphacom",
          "computer village contact",
          "technology support lagos",
          "whatsapp tech support",
          "electronics store contact",
        ]}
        canonical="https://www.alphacomonline.com/contact"
        openGraph={{
          title: "Contact AlphaCom Online - Lagos Technology Store",
          description:
      ...
      <LocalBusinessSchema
        ...
        description="Premium technology store offering expert consultation and support"
        address={{
        ...
        <div className="min-h-screen bg-background" itemScope itemType="https://schema.org/ContactPage">
          <div className="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-20 overflow-hidden">
            <div className="absolute inset-0">
              <img
                src="/modern-office-building-contact-us-hero-background.jpg"
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent className="space-y-6">
                  <p className="text-muted-foreground">
                    Get instant support and product recommendations from our expert team. We're here to help you find
                    the perfect technology solutions for your needs.
                  </p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Over 20 years of experience in technology solutions
                      </p>
                    </div>
                    <div>
